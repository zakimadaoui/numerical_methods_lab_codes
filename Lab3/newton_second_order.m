function newton_second_order (fx_compute, fpx_compute, fppx_compute, dx, epsi, xn0)
    ...
    elseif(f_product < 0) %newton method
        ...
        while(1==1)
            ...
            denominator = fpx_compute(xn0) - (fppx_compute(xn0) * fx_compute(xn0) / fpx_compute(xn0)); 
            xn1 = xn0 - fx_compute(xn0)/denominator;
            if(abs(xn1-xn0) > epsi)
                xn0 = xn1;
